...
function doStrategy() {
    ...
    let sma10 = parseFloat(TI.SMA.calculate({period : 10, values : pair.closes(10)})).toFixed(5)
    let sma40 = parseFloat(TI.SMA.calculate({period : 40, values : pair.closes(40)})).toFixed(5)
